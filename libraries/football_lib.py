...
def run_football_app():
    ...
    # --- 📌 HEADER SECTION ---
    # Note: We use __file__ to find the logo relative to this library file
    # Ensure logo.png is in the same folder as this script, or adjust path
    ...
    elif os.path.exists("logo.png"): # Fallback check in root
