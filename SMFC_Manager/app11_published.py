...
<style>
    ...
    /* 🛠️ READABILITY FIXES (Force White Text) */
    h1, h2, h3, h4, .stMarkdown, p, span, div {
        color: #e0e0e0 !important;
        text-shadow: 0 0 5px rgba(0,0,0,0.8);
    }
    
    /* INPUT LABELS (Guests, Format) */
    label, .stTextInput label, .stSelectbox label {
        color: #d4af37 !important; /* Gold for inputs */
    ...
    .stTabs [aria-selected="true"] {
        background: linear-gradient(90deg, #ff4b4b, #1c83e1) !important;
    ...
    .section-header {
        ...
        border-bottom: 2px solid rgba(255,255,255,0.05); padding-bottom: 10px;
        letter-spacing: 1px;
    }
    ...
    .player-card:hover { transform: translateX(5px); border-color: #666; }
    ...
    div.stButton > button[kind="primary"] {
        ...
        border: none; height: 65px; font-size: 24px !important;
...
# --- 📌 KICKOFF FORMATIONS (0-100 Scale) ---
# X: 0 (Left) -> 100 (Right)
# Y: 0 (Top) -> 100 (Bottom)
# Red on Left (10-45), Blue on Right (55-90)
formation_presets = {
    "9 vs 9": {
        "limit": 9, 
        # Red
        "DEF_R": [(20,20),(20,50),(20,80)], "MID_R": [(35,15),(35,38),(35,62),(35,85)], "FWD_R": [(45,35),(45,65)],
        # Blue (Mirror)
        "DEF_B": [(80,20),(80,50),(80,80)], "MID_B": [(65,15),(65,38),(65,62),(65,85)], "FWD_B": [(55,35),(55,65)]
    },
    "7 vs 7": {
        "limit": 7, 
        "DEF_R": [(20,30),(20,70)], "MID_R": [(35,20),(35,50),(35,80)], "FWD_R": [(45,35),(45,65)],
        "DEF_B": [(80,30),(80,70)], "MID_B": [(65,20),(65,50),(65,80)], "FWD_B": [(55,35),(55,65)]
    },
    "6 vs 6": {
        "limit": 6, 
        "DEF_R": [(20,30),(20,70)], "MID_R": [(35,30),(35,70)], "FWD_R": [(45,35),(45,65)],
        "DEF_B": [(80,30),(80,70)], "MID_B": [(65,30),(65,70)], "FWD_B": [(55,35),(55,65)]
    },
    "5 vs 5": {
        "limit": 5, 
        "DEF_R": [(20,30),(20,70)], "MID_R": [(35,30),(35,70)], "FWD_R": [(45,50)],
        "DEF_B": [(80,30),(80,70)], "MID_B": [(65,30),(65,70)], "FWD_B": [(55,50)]
    }
}
...
with tab1:
    ...
    with c1:
        ...
        st.write("")
        st.markdown("**MANUAL SELECTION**") # Simple Markdown for readability
...
# ==========================================
# TAB 2: TACTICAL BOARD (KICKOFF MODE)
# ==========================================
with tab2:
    if not st.session_state.match_squad.empty:
        # PITCH DRAWING - Clean Green, No Stripes
        ...
        def draw_player(player, x, y, color):
            ...
            # NAME BOX (White background for readability)
        ...
        for _, p in reds.iterrows():
            ...
            # Map Generic pos to Presets Key (DEF -> DEF_R)
            key = f"{pos}_R"
